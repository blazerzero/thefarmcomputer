...
| `/farm-building <name>` | Look up a farm building — cost, materials, size, construction time, and animals housed |
...
| `/tackle <name>` | Look up fishing tackle — description, notes, purchase price, and crafting recipe |
